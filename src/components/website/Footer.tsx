...
import { ChevronUp, Calendar, Heart, Leaf, MapPin, Phone, Trophy, Users } from 'lucide-react';
...
const contactInfo = {
  ...
  phone: '+62 811 334 932 (admin Web - GUNTAR)',
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8'>
          ...
          <div className='lg:col-span-2'>
            ...
            <p className='text-gray-300 mb-6 leading-relaxed'>
              Peringatan HUT RI Ke-80 RW IX Sidoarjo dengan tema <strong>Lingkungan Hidup dan Penghijauan</strong>. Acara ini diselenggarakan untuk
              mempererat persatuan dan kesatuan warga serta meningkatkan kesadaran akan pentingnya menjaga lingkungan hidup.
            </p>
        ...
        <div className='border-t border-gray-800 mt-12 pt-8'>
          <div className='flex flex-col md:flex-row items-center justify-between'>
            ...
            {/* Scroll to Top */}
            <Button onClick={scrollToTop} variant='ghost' size='sm' className='text-gray-300 hover:text-white hover:bg-gray-800'>
