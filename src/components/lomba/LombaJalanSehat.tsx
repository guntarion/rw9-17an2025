        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-blue-700">
              ...
              <strong> Pos Kupon 1</strong> (sampai di timur - rumah Pak Rozak) → Lanjut ke utara menuju Jalan Jatayu → 
              <strong> Pos Kupon 2</strong> (ada pengumpulan kupon 2) → Masuk Jalan Jatayu lurus ke barat sampai pintu keluar → 
              <strong> Pos Kupon 3</strong> (pengumpulan kupon 3) → Jalan lanjut ke arah acara di Balai RW 09 → 
              <strong> Pos Kupon 4</strong> (di panggung) → <strong>Finish</strong>
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>• <strong>Wajib:</strong> Meletakkan kupon di setiap pos yang telah ditentukan</li>
        ...
        <CardContent>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="text-sm text-blue-700">
                • Juri akan menyebar di titik yang sudah ditentukan<br/>
                • Koordinator lomba akan ada briefing khusus untuk tim juri<br/>
                • Untuk penilaian parade tidak ada penilaian khusus, tetap jalan sesuai barisan yang sudah ditentukan
              </div>
            </div>
          </div>
        </CardContent>
