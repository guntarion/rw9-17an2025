        ...
        <CardContent>
          <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg p-6 border-2 border-orange-200">
            <div className="text-center mb-6">
              ...
              <div className="text-sm text-orange-500">Tempat: Area Balai RW IX</div>
            </div>
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-blue-700">
              <strong>Start:</strong> Depan Balai RW IX → Berjalan ke timur menuju Jalan Raya Waru → 
              <strong> Pos Kupon 1</strong> (depan rumah Pak Rozak) → Ke utara menuju Jalan Jatayu → 
              <strong> Pos Kupon 2</strong> (depan pintu masuk Jatayu timur) → Berjalan ke barat sampai pintu keluar Jatayu → 
              <strong> Pos Kupon 3</strong> (pojok barat Jatayu) → Jalan kembali ke barat ketemu Jalan Wedoro PP → 
              Belok kiri ke arah Balai RW IX → <strong> Pos Kupon 4</strong> (panggung) → <strong>Finish</strong>
            </p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          ...
          <div className="text-center mt-4 p-3 bg-blue-50 rounded-lg">
            <div className="text-sm text-blue-700">
              💰 <strong>Total Hadiah:</strong> Rp 1.200.000,-
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>• <strong>Wajib:</strong> Mengambil kupon di setiap pos yang telah ditentukan</li>
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              ...
              <div className="font-semibold text-gray-800">Posisi Start/Finish</div>
              <div className="text-sm text-gray-600">Panitia & Juri di Balai RW 09</div>
            </div>
            <div className="text-center p-4 bg-gray-50 rounded-lg">
              <Route className="w-12 h-12 text-gray-600 mx-auto mb-3" />
              <div className="font-semibold text-gray-800">Juri Keliling</div>
              <div className="text-sm text-gray-600">Mengikuti rute untuk menilai performance</div>
            </div>
          </div>
