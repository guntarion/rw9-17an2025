      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Ada pertanyaan atau saran tentang HUT RI Ke-80 RW IX? 
            Jangan ragu untuk menghubungi panitia pelaksana
          </p>
        </div>
              ...
              <CardContent>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button 
                    type="submit" 
                    size="lg" 
                    className="w-full bg-gradient-green hover:shadow-green"
              ...
              <CardContent>
                ...
                <Alert className="mt-4">
                  ...
                  <AlertDescription className="text-sm">
                    Respons tercepat melalui WhatsApp. Email akan dibalas dalam 1x24 jam.
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
            ...
            <Card className="border-red-200 bg-red-50">
              ...
              <CardContent>
                <p className="text-sm text-red-600 mb-3">
                  Untuk situasi darurat atau mendesak selama acara:
                </p>
